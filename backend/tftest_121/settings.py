"""
Django settings for tftest_121 project.
...
WSGI_APPLICATION = 'tftest_121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tftest_121 API",
    "DESCRIPTION": "API documentation for tftest_121 App",
    "VERSION": "v1",
}
